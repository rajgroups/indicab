        ...
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="#" class="logo-link">
                    <img class="logo-light logo-img" src="{{asset('resource/web/images/logo/log.png')}}" srcset="{{asset('resource/web/images/logo/logo.png')}} 2x" alt="logo">
                    <img class="logo-dark logo-img" src="{{asset('resource/web/images/logo/log.png')}}" srcset="{{asset('resource/web/images/logo/logo.png')}} 2x" alt="logo-dark">
                </a>
            </div><!-- .nk-header-brand -->
                    ...
                    <li class="dropdown user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-md dropdown-menu-end dropdown-menu-s1">
                            ...
                            <div class="dropdown-inner">
                                <ul class="link-list">
                                    <li><a href="{{ route('admin.password.change') }}"><em class="icon ni ni-user-alt"></em><span>Change Password</span></a></li>
