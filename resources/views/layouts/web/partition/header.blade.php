<header class="header" style="position: static">
    @include('layouts.web.partition.top_header')
    <div class="container">
       <nav class="navbar navbar-expand-lg header-nav p-0">
          <div class="navbar-header">
             ...
             <img src="{{ asset('resource/web/assets/img/logo.jpg')}}" class="img-fluid" alt="Logo">
             </a>
          </div>
             ...
             <ul class="main-nav">
                <li class="active has-submenu">
                   ...
                   <ul class="submenu">
                      ...
                      {{-- <li class="active"><a href="/" target="_blank"></a></a></li> --}}
                ...
                <li class="has-submenu">
                  ...
                  {{-- <li>
                    <a href="/cab" target="_blank">Cab Service</a>
                 </li>
                <li>
                    <a href="/all_services" target="_blank">All Services</a>
                 </li>
                 <li>
                     <a href="/tempo_service" target="_blank">Tempo Service</a>
                  </li>
                <li>
                    <a href="/packers_movers" target="_blank">Packers and Movers</a>
                 </li>
                <li>
          ...
          <ul class="nav header-navbar-rht reg-head">
             <li><a href="register.html" class="reg-btn"><img src="{{ asset('resource/web/assets/img/icon/users.svg')}}" class="me-1" alt="img">Register</a></li>
             <li><a href="login.html" class="log-btn"><img src="{{ asset('resource/web/assets/img/icon/lock.svg')}}" class="me-1" alt="img"> Login</a></li>
