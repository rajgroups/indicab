            ...
            <div class="dot-slider slider">
               <div class="profile-widget-slide">
                  <div class="slide-pro-img">
                     ...
                     <img class="img-fluid" src="{{ asset('resource/web/assets/img/slider/slider-01.jpg')}}" alt="Img">
                     </a>
                  </div>
               </div>
               <div class="profile-widget-slide">
            ...
            <div class="container">
               ...
               <div class="row justify-content-center">
                  <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                     <div class="different-categories-blk aos" data-aos="fade-up">
                        <div class="differ-img">
                           <img src="{{ asset('resource/web/assets/img/icon/category-01.svg')}}" alt="Img">
                        </div>
                        <div class="differ-img-right">
                           <img src="{{ asset('resource/web/assets/img/icon/category-09.svg')}}" alt="Img">
                        </div>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                     <div class="different-categories-blk aos" data-aos="fade-up">
                        <div class="differ-img">
                           <img src="{{ asset('resource/web/assets/img/icon/category-02.svg')}}" alt="Img">
                        </div>
                        <div class="differ-img-right">
                           <img src="{{ asset('resource/web/assets/img/icon/category-10.svg')}}" alt="Img">
                        </div>
                        <div class="differ-content">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                     <div class="different-categories-blk aos" data-aos="fade-up">
                        <div class="differ-img">
                           <img src="{{ asset('resource/web/assets/img/icon/category-03.svg')}}" alt="Img">
                        </div>
                        <div class="differ-img-right">
                           <img src="{{ asset('resource/web/assets/img/icon/category-11.svg')}}" alt="Img">
                        </div>
                        <div class="differ-content">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                     <div class="different-categories-blk aos" data-aos="fade-up">
                        <div class="differ-img">
                           <img src="{{ asset('resource/web/assets/img/icon/category-04.svg')}}" alt="Img">
                        </div>
                        <div class="differ-img-right">
                           <img src="{{ asset('resource/web/assets/img/icon/category-12.svg')}}" alt="Img">
                        </div>
                        <div class="differ-content">
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                     <div class="different-categories-blk aos" data-aos="fade-up">
                        <div class="differ-img">
                           <img src="{{ asset('resource/web/assets/img/icon/category-05.svg')}}" alt="Img">
                        </div>
                        <div class="differ-img-right">
                           <img src="{{ asset('resource/web/assets/img/icon/category-13.svg')}}" alt="Img">
                        </div>
                        <div class="differ-content">
                           <h6>Illustration</h6>
                           <p>Web development, UI/UX development, Module development & more</p>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                     <div class="different-categories-blk aos" data-aos="fade-up">
                        <div class="differ-img">
                           <img src="{{ asset('resource/web/assets/img/icon/category-06.svg')}}" alt="Img">
                        </div>
                        <div class="differ-img-right">
                           <img src="{{ asset('resource/web/assets/img/icon/category-14.svg')}}" alt="Img">
                        </div>
                        <div class="differ-content">
                           <h6>Link Building</h6>
                           <p>Web development, UI/UX development, Module development & more</p>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                     <div class="different-categories-blk aos" data-aos="fade-up">
                        <div class="differ-img">
                           <img src="{{ asset('resource/web/assets/img/icon/category-07.svg')}}" alt="Img">
                        </div>
                        <div class="differ-img-right">
                           <img src="{{ asset('resource/web/assets/img/icon/category-15.svg')}}" alt="Img">
                        </div>
                        <div class="differ-content">
                           <h6>Android Apps</h6>
                           <p>Web development, UI/UX development, Module development & more</p>
                  ...
                  <div class="col-xl-3 col-lg-4 col-md-6 d-flex">
                     <div class="different-categories-blk aos" data-aos="fade-up">
                        <div class="differ-img">
                           <img src="{{ asset('resource/web/assets/img/icon/category-08.svg')}}" alt="Img">
                        </div>
                        <div class="differ-img-right">
                           <img src="{{ asset('resource/web/assets/img/icon/category-16.svg')}}" alt="Img">
                        </div>
                        <div class="differ-content">
                           <h6>MYSQL</h6>
                           <p>Web development, UI/UX development, Module development & more</p>
                  ...
                  <div class="col-md-6 d-flex align-items-center">
                     <div class="market-place-group section-header-three aos" data-aos="fade-up">
                        ...
                        <div class="market-place-btn">
                           <a href="project.html" class="btn btn-primary market-project me-2">Post a Project<i class="feather-arrow-right ms-2"></i></a>
                           <a href="developer-details.html" class="btn btn-primary market-developer">Find Developers<i class="feather-arrow-right ms-2"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col-md-6">
                     <div class="markrt-place-img aos" data-aos="fade-up">
                        <img src="{{ asset('resource/web/assets/img/market-place.png')}}" class="img-fluid" alt="Img">
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div id="trend-slider" class="owl-carousel owl-theme trend-slider aos" data-aos="fade-up">
                  <div class="project-item trend-project-item">
                     <div class="project-img">
                        <a href="project.html"><img src="{{ asset('resource/web/assets/img/project/project-25.jpg')}}" alt="Img" class="img-fluid"></a>
                     </div>
                     <div class="trend-project-content">
                        ...
                        <div class="trend-rate">
                           <ul class="nav">
                              <li><span>$200</span></li>
                              <li><a href="javascript:void(0);">Learn More<i class="feather-arrow-right ms-2"></i></a></li>
                           </ul>
                        </div>
                     </div>
                  </div>
                  <div class="project-item trend-project-item">
                     <div class="project-img">
                        <a href="project.html"><img src="{{ asset('resource/web/assets/img/project/project-26.jpg')}}" alt="Img" class="img-fluid"></a>
                     </div>
                     <div class="trend-project-content">
                        <div class="star-rated">
                           <div class="rating">
                  ...
                  <div class="project-item trend-project-item">
                     <div class="project-img">
                        <a href="project.html"><img src="{{ asset('resource/web/assets/img/project/project-27.jpg')}}" alt="Img" class="img-fluid"></a>
                     </div>
                     <div class="trend-project-content">
                        <div class="star-rated">
                           <div class="rating">
                        ...
                        <h4><a href="project.html">Landing Page Redesign / Sales Page Redesign</a></h4>
                        <ul class="trend-project-list">
                           <li><i class="feather-user me-1"></i>Web Development</li>
                           <li><i class="feather-map-pin me-1"></i>Delaware, USA</li>
                        </ul>
                  ...
                  <div class="project-item trend-project-item">
                     ...
                     <div class="trend-project-content">
                        ...
                        <h4><a href="project.html">Build a Coaching Website Product Store images</a></h4>
                        <ul class="trend-project-list">
         ...
         <section class="section feaure-project">
            <div class="container">
               ...
               <div id="feature-project-slider" class="feature-dev-three owl-carousel owl-theme trend-slider aos" data-aos="fade-up">
                  <div class="project-item project-item-feature">
                     <div class="project-img heart-blk">
                        <a href="developer-details.html"><img src="{{ asset('resource/web/assets/img/developer/developer-05.jpg')}}" alt="Img" class="img-fluid"></a>
                        <h5 class="hour-dollr">$64 <span>/ hr</span></h5>
                     </div>
                     <div class="feature-project-content">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                           <h4 class="d-flex"><a href="developer-details.html">Megan Torres</a><img src="{{ asset('resource/web/assets/img/icon/verify-badge.svg')}}" class="ms-1" alt="Img"></h4>
                           <a href="javascript:void(0);" class="select-favourite"><i class="fa-regular fa-bookmark"></i></a>
                        </div>
                        <p>Java Developer</p>
                  ...
                  <div class="project-item project-item-feature">
                     <div class="project-img heart-blk">
                        <a href="developer-details.html"><img src="{{ asset('resource/web/assets/img/developer/developer-06.jpg')}}" alt="Img" class="img-fluid"></a>
                        <h5 class="hour-dollr">$54 <span>/ hr</span></h5>
                     </div>
                     <div class="feature-project-content">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                           <h4 class="d-flex"><a href="developer-details.html">Nicole Black</a><img src="{{ asset('resource/web/assets/img/icon/verify-badge.svg')}}" class="ms-1" alt="Img"></h4>
                           <a href="javascript:void(0);" class="select-favourite"><i class="fa-regular fa-bookmark"></i></a>
                        </div>
                  ...
                  <div class="project-item project-item-feature">
                     <div class="project-img heart-blk">
                        <a href="developer-details.html"><img src="{{ asset('resource/web/assets/img/developer/developer-07.jpg')}}" alt="Img" class="img-fluid"></a>
                        <h5 class="hour-dollr">$50 <span>/ hr</span></h5>
                     </div>
                     <div class="feature-project-content">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                           <h4 class="d-flex"><a href="developer-details.html">Shan Morris</a><img src="{{ asset('resource/web/assets/img/icon/verify-badge.svg')}}" class="ms-1" alt="Img"></h4>
                           <a href="javascript:void(0);" class="select-favourite"><i class="fa-regular fa-bookmark"></i></a>
                        </div>
                        <p>Html Developer</p>
                        <div class="d-flex justify-content-between align-items-center">
                  ...
                  <div class="project-item project-item-feature">
                     <div class="project-img heart-blk">
                        <a href="developer-details.html"><img src="{{ asset('resource/web/assets/img/developer/developer-08.jpg')}}" alt="Img" class="img-fluid"></a>
                        <h5 class="hour-dollr">$55 <span>/ hr</span></h5>
                     </div>
                     <div class="feature-project-content">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                           <h4 class="d-flex"><a href="developer-details.html">Harris Jod</a><img src="{{ asset('resource/web/assets/img/icon/verify-badge.svg')}}" class="ms-1" alt="Img"></h4>
                           <a href="javascript:void(0);" class="select-favourite"><i class="fa-regular fa-bookmark"></i></a>
                        </div>
                        <p>React Developer</p>
                        <div class="d-flex justify-content-between align-items-center">
               ...
               <div class="row">
                  <div class="col-xl-12">
                     <div class="more-project text-center aos aos-init aos-animate" data-aos="fade-up">
                        <a href="project.html" class="btn btn-primary">View More Developers<i class="feather-arrow-right ms-2"></i></a>
                     </div>
                  </div>
               </div>
            </div>
               ...
               <div class="trend-slider aos row" data-aos="fade-up">
                     ...
                     <div class="review-blog user-review">
                        <div class="review-top ">
                           <div class="review-img mx-auto">
                              <a href="review.html"><img class="img-fluid" src="{{ asset('resource/web/assets/img/user/review-user-01.jpg')}}" alt="Post Image"></a>
                           </div>
                           <div class="rating">
                              <i class="fas fa-star filled"></i>
                              <i class="fas fa-star filled"></i>
                  ...
                  <div class="col-lg-4 col-md-6">
                     <div class="review-blog user-review">
                        <div class="review-top ">
                           <div class="review-img mx-auto">
                              <a href="review.html"><img class="img-fluid" src="{{ asset('resource/web/assets/img/user/review-user-02.jpg')}}" alt="Post Image"></a>
                           </div>
                           <div class="rating">
                              <i class="fas fa-star filled"></i>
                              <i class="fas fa-star filled"></i>
                  ...
                  <div class="col-md-12">
                     <div class="job-next-blk text-center aos" data-aos="fade-up">
                        ...
                        <div class="next-job-btn">
                           <a href="register.html" class="btn btn-primary next-register me-3">Register Kofejob<i class="feather-arrow-right ms-2"></i></a>
                           <a href="login.html" class="btn btn-primary next-sign">Post A Project<i class="feather-arrow-right ms-2"></i></a>
                        </div>
                     </div>
                  </div>
               </div>
                  ...
                  <div class="col-lg-6 col-md-12">
                     <div class="blog blog-trick aos" data-aos="fade-up">
                        <div class="blog-image">
                           <a href="blog-details.html"><img class="img-fluid" src="{{ asset('resource/web/assets/img/blog/blog-21.jpg')}}" alt="Post Image"></a>
                        </div>
                        <div class="blog-trick-content-main">
                              ...
                              <ul class="entry-meta meta-item d-flex align-items-center mb-0">
                                 <li>
                                    <div class="post-author blog-hover-img">
                                       <a href="developer-details.html"><img src="{{ asset('resource/web/assets/img/img-02.jpg')}}" alt="Post Author"> <span> Rihana madonna</span></a>
                                    </div>
                                 </li>
                                 <li>
                           ...
                           <div class="blog-content blog-trick-content">
                              <h3 class="blog-title"><a href="blog-details.html">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Amet.</a></h3>
                              <p>Lorem ipsum dolor sit amet consectetur. Vitae amet cras nulla mi laoreet quis amet phasellus....</p>
                           </div>
                           <a href="javascript:void(0);" class="more-option">Learn More<i class="feather-arrow-right ms-2"></i></a>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-6 col-md-12">
                        ...
                        <div class="row align-items-center">
                           <div class="col-sm-4">
                              <div class="blog-image blog-list-img">
                                 <a href="blog-details.html"><img class="img-fluid" src="{{ asset('resource/web/assets/img/blog/blog-list-01.jpg')}}" alt="Post Image"></a>
                              </div>
                           </div>
                           <div class="col-sm-8">
                              <div class="blog-trick-content-main blog-list-main">
                                 <div class="blog-content blog-trick-content">
                                    <h3 class="blog-title"><a href="blog-details.html">Lorem ipsum dolor sit amet, </a></h3>
                                 ...
                                 <div class="d-flex justify-content-between align-items-center mb-2 mt-2">
                                    <ul class="entry-meta meta-item d-flex align-items-center mb-0">
                                       <li>
                                          <div class="post-author blog-hover-img">
                                             <a href="developer-details.html"><img src="{{ asset('resource/web/assets/img/img-03.jpg')}}" alt="Post Author"> <span> Aidan Funnell</span></a>
                                          </div>
                                       </li>
                                       <li>
                                          <i class="feather-calendar"></i>
                     ...
                     <div class="blog blog-trick aos" data-aos="fade-up">
                        <div class="row align-items-center">
                           <div class="col-sm-4">
                              <div class="blog-image blog-list-img">
                                 <a href="blog-details.html"><img class="img-fluid" src="{{ asset('resource/web/assets/img/blog/blog-list-02.jpg')}}" alt="Post Image"></a>
                              </div>
                           </div>
                           <div class="col-sm-8">
                              <div class="blog-trick-content-main blog-list-main">
                                 ...
                                 <div class="d-flex justify-content-between align-items-center mb-2 mt-2">
                                    <ul class="entry-meta meta-item d-flex align-items-center mb-0">
                                       <li>
                                          <div class="post-author blog-hover-img">
                                             <a href="developer-details.html"><img src="{{ asset('resource/web/assets/img/img-04.jpg')}}" alt="Post Author"> <span> Cameron Morley</span></a>
                                          </div>
                                       </li>
                                       <li>
                                          <i class="feather-calendar"></i>
                     ...
                     <div class="blog blog-trick aos" data-aos="fade-up">
                        <div class="row align-items-center">
                           <div class="col-sm-4">
                              <div class="blog-image blog-list-img">
                                 <a href="blog-details.html"><img class="img-fluid" src="{{ asset('resource/web/assets/img/blog/blog-list-03.jpg')}}" alt="Post Image"></a>
                              </div>
                           </div>
                           <div class="col-sm-8">
                              <div class="blog-trick-content-main blog-list-main">
                                 ...
                                 <div class="d-flex justify-content-between align-items-center mb-2 mt-2">
                                    <ul class="entry-meta meta-item d-flex align-items-center mb-0">
                                       <li>
                                          <div class="post-author blog-hover-img">
                                             <a href="developer-details.html"><img src="{{ asset('resource/web/assets/img/img-05.jpg')}}" alt="Post Author"> <span> Amelie Hannah</span></a>
                                          </div>
                                       </li>
                                       <li>
                                          <i class="feather-calendar"></i>
