                        ...
                        <div class="nk-block-between g-3">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">Home /
                                    <strong class="text-primary small">service/
                                        <strong class="text-primary small">Inactive list/
                                        </strong>
                                </h3>
                            ...
                            <div class="nk-block-head-content">
                                <a href="{{ route('admin.service.create') }}"
                                    ...
                                    <span>Create</span></a><a href="{{ route('admin.service.create') }}"
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd">
                                            ...
                                            <td class="d-flex">
                                                    ...
                                                    <a href="{{ route('admin.service.edit',$service->id) }}"><i class="fa fa-pencil p-2"></i></a>
                                                   <!-- Delete Button with Confirmation Alert -->
                                                    <form action="{{ route('admin.service.destroy', $service->id) }}" method="POST" onsubmit="return confirmDelete()">
                                                        @csrf
                                                        @method('DELETE')
