                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body card-body">
                                        ...
                                        <form action="{{ route('admin.service.store') }}" class="form-validate" method="post" id="service_form" novalidate="novalidate" >
                                            @csrf
                                            @method('POST')
                                            <!-- Category Name -->
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Service Name" value="{{ old('name') }}" required>
                                              ...
                                              <div class="form-group row">
                                                ...
                                                <div class="col-sm-4">
                                                    <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="Service slug" value="{{ old('slug') }}" required>
                                                    {{-- <span class="invalid">This field is required.</span> --}}
                                                    <div class="valid-feedback"> Looks good! </div>
                                                    <div class="invalid-feedback">This field is required.</div>
                                                    @error('slug')
