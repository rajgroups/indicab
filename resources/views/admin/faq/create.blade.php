                        ...
                        <div class="nk-block-between g-3">
                            ...
                            <div class="nk-block-head-content">
                                <a href="{{ route('admin.faq.index') }}"
                                    ...
                                    <span>Back</span></a><a href="{{ route('admin.faq.index') }}"
                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body card-body">
                                        ...
                                        <form action="{{ route('admin.faq.store') }}" class="form-validate" method="post" id="location_form" novalidate="novalidate" enctype="multipart/form-data">
                                            @csrf
                                            @method('POST')
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        <label for="question" class="col-sm-4 text-right col-form-label"> Your Qustion <i class="text-danger">*</i>:</label>
                                                        <div class="col-sm-8">
                                                            <input type="text" name="question" class="form-control @error('question') is-invalid @enderror" id="question" placeholder="Enter question" value="{{ old('question') }}" required>
                                                    ...
                                                    <!-- Service -->
                                                    <div class="form-group row">    
                                                        <label for="service_id" class="col-sm-4 text-right col-form-label">Service <i class="text-danger">* </i>:</label>
                                                        <div class="col-sm-8">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            <label for="answer" class="text-right col-form-label">Answer <i class="text-danger">* </i>:</label>
                                                            <textarea name="answer" id="answer" class="form-control answer" cols="30" rows="10" placeholder="Please Enter the answer" required></textarea>
                                                            {{-- <span class="invalid">This field is required.</span> --}}
                                                            <div class="valid-feedback"> Looks good! </div>
                                                            <div class="invalid-feedback">This field is required.</div>
                                                            @error('answer')
                                                ...
                                                <div class="col-md-12 mb-3">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-6 text-right">
                                                            ...
                                                            <a href="{{ route('admin.faq.create') }}"></a> <button type="submit" class="btn btn-success" name="add-another">Save And Add Another</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
