                            ...
                            <div class="col-sm-12">
                                <div class="panel panel-bd lobidrag">
                                    ...
                                    <div class="panel-body card-body">
                                        ...
                                        <form action="{{ route('admin.page.store') }}" class="form-validate" method="post" id="location_form" novalidate="novalidate" enctype="multipart/form-data">
                                            @csrf
                                            @method('POST')
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="seo_title" id="seo_title" class="form-control @error('seo_title') is-invalid @enderror" placeholder="Enter SEO Title" value="{{ old('seo_title') }}" required />
                                                        @error('seo_title')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="seo_description" id="seo_description" class="form-control @error('seo_description') is-invalid @enderror" rows="3" placeholder="Enter Meta Description" required>{{ old('seo_description') }}</textarea>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="seo_keywords" id="seo_keywords" class="form-control @error('seo_keywords') is-invalid @enderror" rows="3" placeholder="Enter Meta keywords" required>{{ old('seo_keywords') }}</textarea>
                                                        @error('seo_keywords')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                        <small id="descriptionHelp" class="text-muted">Meta description should be between 150 to 160 characters long.</small>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="area" id="area" class="form-control @error('area') is-invalid @enderror" value="{{ old('area') }}" placeholder="Please enter target area name" required>
                                                        @error('area')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="city" id="city" class="form-control @error('city') is-invalid @enderror"  value="{{ old('city') }}" placeholder="Please enter target City name" required>
                                                        @error('area')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                        <small id="descriptionHelp" class="text-muted"></small>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="og_title" id="og_title" class="form-control @error('og_title') is-invalid @enderror" placeholder="Enter SEO Title" value="{{ old('og_title') }}" required />
                                                        @error('og_title')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                        <small id="titleHelp" class="text-muted">SEO Title should be between 50 to 60 characters long.</small>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="file" class="form-control @error('og_image') is-invalid @enderror" name="og_image" id="og_image" placeholder="Please Choose Meta OG Image" aria-describedby="fileHelpId" required />
                                                        @error('og_image')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                        <div id="fileHelpId" class="form-text"><b>Allowed:</b> JPG,PNG,JPEG,GIF</div>
                                                    </div>
                                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/640px-No-Image-Placeholder.svg.png" alt="" id="og-image-preview" srcset="" style="height: 175px">
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label for="" class="form-label">Og Meta Desciption</label>
                                                        <textarea name="og_description" id="og_description" class="form-control @error('og_description') is-invalid @enderror" rows="3" placeholder="Enter Meta og_description" required>{{ old('og_description') }}</textarea>
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="first_title" id="first_title" class="form-control @error('first_title') is-invalid @enderror" placeholder="Enter H1 Title" value="{{ old('first_title') }}" required/>
                                                        @error('first_title')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                        <small id="titleHelp" class="text-muted">SEO Title should be between 50 to 60 characters long.</small>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="first_description" id="first_description" class="form-control @error('first_description') is-invalid @enderror" rows="3" placeholder="Enter first_description" required>{{ old('first_description') }}</textarea>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <textarea name="short_tag" id="short_tag" class="form-control @error('short_tag') is-invalid @enderror" rows="3" placeholder="Enter short_tag" required>{{ old('short_tag') }}</textarea>
                                                        @error('short_tag')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="file" class="form-control @error('banner_image') is-invalid @enderror" name="banner_image" id="banner_image" placeholder="Please Choose banner Image" aria-describedby="fileHelpId" required/>
                                                        @error('banner_image')
                                                            <span class="invalid-feedback">{{ $message }}</span>
                                                        @enderror
                                                        <div id="fileHelpId" class="form-text"><b>Allowed:</b> JPG,PNG,JPEG,GIF</div>
                                                    </div>
                                                    <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/640px-No-Image-Placeholder.svg.png" alt="" id="banner-image-preview" srcset="" style="height: 175px">
                                                </div>
                                            </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input @error('sub_category_service') is-invalid @enderror" type="radio" name="sub_category_service" value="yes" id="flexRadioDefault1" required>
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                          Yes
                                                        </label>
                                                      </div>
                                                      <div class="form-check">
                                                        <input class="form-check-input @error('sub_category_service') is-invalid @enderror" type="radio" name="sub_category_service" value="no" id="flexRadioDefault2" checked>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input  @error('service_location') is-invalid @enderror" type="radio" name="service_location" value="yes" id="flexRadioDefault1" required>
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                          Yes
                                                        </label>
                                                      </div>
                                                      <div class="form-check">
                                                        <input class="form-check-input  @error('service_location') is-invalid @enderror" type="radio" name="service_location" value="no" id="flexRadioDefault2" checked>
                                                        <label class="form-check-label" for="flexRadioDefault2">
                                                          No
                                                        </label>
                                                      </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input @error('price') is-invalid @enderror" type="radio" name="price" value="yes" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                          Yes
                                                        </label>
                                                      </div>
                                                      <div class="form-check">
                                                        <input class="form-check-input @error('price') is-invalid @enderror" type="radio" name="price" value="no" id="flexRadioDefault2" checked>
                                                        <label class="form-check-label" for="flexRadioDefault2">
                                                          No
                                                        </label>
                                                      </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input @error('tesimonial') is-invalid @enderror" type="radio" name="tesimonial" value="yes" id="flexRadioDefault1" required>
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                          Yes
                                                        </label>
                                                      </div>
                                                      <div class="form-check">
                                                        <input class="form-check-input @error('tesimonial') is-invalid @enderror" type="radio" name="tesimonial" value="no" id="flexRadioDefault2" checked>
                                                        <label class="form-check-label" for="flexRadioDefault2">
                                                          No
                                                        </label>
                                                      </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-check">
                                                        <input class="form-check-input @error('faq') is-invalid @enderror" type="radio" name="faq" value="yes" id="flexRadioDefault1">
                                                        <label class="form-check-label" for="flexRadioDefault1">
                                                          Yes
                                                        </label>
                                                      </div>
                                                      <div class="form-check">
                                                        <input class="form-check-input @error('faq') is-invalid @enderror" type="radio" name="faq" value="no" id="flexRadioDefault2" checked>
                                                        <label class="form-check-label" for="flexRadioDefault2">
                                                          No
                                                        </label>
                                                      </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="text" name="first_content_title" id="first_content_title" class="form-control @error('first_content_title') is-invalid @enderror" placeholder="Enter first_content_title" value="{{ old('first_content_title') }}" required/>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="first_content_description" id="first_content_description" class="form-control @error('first_content_description') is-invalid @enderror" rows="3" placeholder="Enter first_content_description" required>{{ old('first_content_description') }}</textarea>
                                                        ...
                                                        <div class="mb-3">
                                                            ...
                                                            <textarea name="content_short_tag" id="content_short_tag" class="form-control @error('content_short_tag') is-invalid @enderror" rows="3" placeholder="Enter short-tag" required>{{ old('content_short_tag') }}</textarea>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="mb-3">
                                                            ...
                                                            <input type="file" class="form-control @error('side_image') is-invalid @enderror" name="side_image" id="side_image" placeholder=""aria-describedby="fileHelpId" required/>
                                                            @error('side_image')
                                                                <span class="invalid-feedback">{{ $message }}</span>
                                                            @enderror
                                                            <div id="fileHelpId" class="form-text"><b>Allowed:</b> JPG,PNG,JPEG,GIF</div>
                                                        </div>
                                                        <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/640px-No-Image-Placeholder.svg.png" alt="" id="side-image-preview" srcset="" style="height: 175px">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mt-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Slug Name" value="{{ old('name') }}" required>
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="text" name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="URL slug" value="{{ old('slug') }}" required>
                                                            {{-- <span class="invalid">This field is required.</span> --}}
                                                            <div class="valid-feedback"> Looks good! </div>
                                                            <div class="invalid-feedback">This field is required.</div>
                                                            @error('slug')
                                                     ...
                                                     <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-8">
                                                            <input type="file" name="feature_image" class="form-control @error('feature_image') is-invalid @enderror" id="feature_image" placeholder="Feature Image" value="{{ old('feature_image') }}" required>
                                                            {{-- <span class="invalid">This field is required.</span> --}}
                                                            <div class="valid-feedback"> Looks good! </div>
                                                            <div class="invalid-feedback">This field is required.</div>
                                                            @error('feature_image')
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group row">
                                                        <div class="col-sm-12">
                                                            ...
                                                            <img src="{{ asset('https://upload.wikimedia.org/wikipedia/commons/thumb/6/65/No-Image-Placeholder.svg/640px-No-Image-Placeholder.svg.png') }}" alt="feature_image Image" id="feature_image-preview" width="210px">
                                                        </div>
                                                    </div>
                                                </div>
